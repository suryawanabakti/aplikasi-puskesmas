...
Route::middleware('auth')->group(function () {
    Route::group(['middleware' => ['role:admin|super-admin']], function () {
        ...
        Route::put('/admin/master-data/posyandu/{pasien}', [PosyanduController::class, 'store'])->name('admin.master-data.posyandu.update');
        ...
        Route::get('/admin/master-data/golongan/edit/{golongan}', [GolonganController::class, 'edit'])->name('admin.master-data.golongan.edit');
    ...
    Route::group(['middleware' => ['role:super-admin|pimpinan']], function () {
